...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，I am a biostatistician, Hi，I am a researcher in mental health,Welcome 🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://scholar.google.com/citations?user=d_VoC2MAAAAJ&hl', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Xueyi Shen, Mental health, University of Edinburgh, Neuroscience, Genomics', // 网站关键词 英文逗号隔开
